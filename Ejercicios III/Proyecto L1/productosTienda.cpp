...
void productosTienda(int opc) {
	...
	case 2: {
		...
		case 1: {
			...
			cout << "\t PRODUCTO \t\t\t   PRECIO" << endl;
			cout << endl;
			cout << "1 - Xiaomi POCO X3 RAM 6GB " << " \t\t L 8,500.00 " << endl;
			cout << "2 - Xiaomi Redmi 10  " << " \t\t\t L 9,500.00 " << endl;
			cout << "3 - Xiaomi Redmi Note 10 Pro " << " \t\t L 11,500.00 " << endl;
			cout << "4 - Xiaomi Redmi Note 9 Pro  " << " \t\t L 7,000.00 " << endl;
			cout << "5 - Xiaomi Mi 11 Lite " << " \t\t\t L 9,200.00 " << endl;
			cout << endl;
			cout << "Seleccione el producto que desea comprar --> : ";
			cin >> selectprd;
			...
			case 1: {
				agregarProductotienda("1 - Xiaomi POCO X3 RAM 6GB - L 8,500.00 ", 1, 8500);
				break;
			}

			case 2: {
				agregarProductotienda("1 - Xiaomi Redmi 10 - L 9,500.00 ", 1, 9500);
				break;
			}
		...
		case 2: {
			...
			cout << "\t PRODUCTO \t\t\t\t\t  PRECIO" << endl;
			cout << endl;
			cout << "1 - Samsung Galaxy A13 " << " \t\t\t\t L 6,295.00 " << endl;
			cout << "2 - Samsung Galaxy A23" << " \t\t\t\t\t L 7,500.00 " << endl;
			cout << "3 - Samsung Galaxy S21 FE " << " \t\t\t\t L 17,995.00 " << endl;
			cout << "4 - Cargador Inalambrico Samsung " << " \t\t\t L 1,900.00 " << endl;
			cout << "5 - Cobertor de Silicon Samsung Galaxy S21 FE" << " \t\t L 650.00 " << endl;
			cout << "6 - Samsung Wireless Charger Stand (15W)" << " \t\t L 1,200.00 " << endl;
			cout << endl;
			cout << "Seleccione el producto que desea comprar --> : ";
			cin >> selectprd;
			...
			case 1: {
				agregarProductotienda("1 - Samsung Galaxy A13 - L 6,295.00 ", 1, 6295);
				break;
			}

			case 2: {
				agregarProductotienda("1 - Samsung Galaxy A23 - L 7,500.00 ", 1, 7500);
				break;
			}
		...
		case 3: {
			...
			cout << "\t PRODUCTO \t\t\t  PRECIO" << endl;
			cout << endl;
			cout << "1 - Apple iPhone 13 " << " \t\t\t L 30,500.00 " << endl;
			cout << "2 - Apple Cargador Inalambrico " << " \t L 1,300.00 " << endl;
			cout << "3 - Apple iPhone XR " << " \t\t\t L 10,200.00 " << endl;
			cout << "4 - Apple iPhone 11 Pro " << " \t\t L 14,500.00 " << endl;
			cout << endl;
			cout << "Seleccione el producto que desea comprar --> : ";
			cin >> selectprd;
	...
	case 3: {
		...
		case 1: {
			...
			cout << "\t PRODUCTO \t\t\t\t\t  PRECIO" << endl;
			cout << endl;
			cout << "1 - Laptop Dell Inspiron 15 pulg / AMD Ryzen 7" << " \t\t L 18,000.00 " << endl;
			cout << "2 - Laptop Dell Inspiron 15 pulg 3205 / Celeron N4020" << " \t L 10,000.00 " << endl;
			cout << endl;
			cout << "Seleccione el producto que desea comprar --> : ";
			cin >> selectprd;
			...
			case 1: {
				agregarProductotienda("1 - Laptop Dell Inspiron 15 pulg /AMD Ryzen 7/8GB RAM - L 18,000.00 ", 1, 18000);
				break;
			}

			case 2: {
				agregarProductotienda("1 - Laptop Dell Inspiron 15 pulg 3205/Celeron N4020/4GB RAM - L 10,000.00 ", 1, 10000);
				break;
			}
		...
		case 2: {
			...
			cout << "\t\t\t PRODUCTO \t\t\t\t  PRECIO" << endl;
			cout << endl;
			cout << "1 - Laptop Lenovo IdeaPad D330 10 pulg / Intel Celeron/4GB RAM" << " \t L 7,000.00 " << endl;
			cout << "2 - Laptop Lenovo IdeaPad 3 14 pulg/ i3/ 8GB RAM" << " \t\t L 17,000.00 " << endl;
			cout << "3 - Laptop Lenovo IdeaPad Gaming 3 15 pulg/ i5/ 8GB RAM " << " \t L 24,000.00 " << endl;
			cout << endl;
			cout << "Seleccione el producto que desea comprar --> : ";
			cin >> selectprd;
		...
		case 3: {
			...
			cout << "\t\t PRODUCTO \t\t\t\t    PRECIO" << endl;
			cout << endl;
			cout << "1 - Laptop HP 14 pulg / Intel Core i5 / 8GB RAM " << "\t L 19,000.00 " << endl;
			cout << "2 - Laptop HP Victus 16 pulg / Intel Core i5/ 8GB RAM " << " \t L 28,000.00 " << endl;
			cout << "3 - Laptop HP 15 pulg / AMD Ryzen 5 / 8GB RAM " << " \t\t L 18,000.00 " << endl;
			cout << endl;
			cout << "Seleccione el producto que desea comprar --> : ";
			cin >> selectprd;
