...
int main(){
	...
	float IHSS, RAP, deducciones, totalSalario,exedente;
	...
	cout<<endl;
	//CAPTURA DE DATOS
	cout<<"Ingrese el presupuesto de la planilla actual: L. "; cin>>presupuesto;
	while (des == 1){
	cout<<"Introduzca las horas laboradas por el empleado # "<<cont+1<<": ";  cin>>horasLab;
	cout<<"Introduzca el pago por hora del empleado #"<<cont+1<<": L. "; cin>>pagoHora;
	if (horasLab > 40){
	//PROCESOS
	...
	totalSalario=(salario - deducciones);
	...
	cout<<endl;cout<<endl;
	cout<<"<<<<<<<<<<<<SALARIO>>>>>>>>>>>> "<<endl;
	cout<<"El salario del empleado es: "<<totalSalario<<endl;
