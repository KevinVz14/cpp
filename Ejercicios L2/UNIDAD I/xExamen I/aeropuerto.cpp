...
float precioBoleto = 0, pF = 0,suma = 0, promedio = 0;
    ...
    float precioFinal(){
        ...
        if (edad<12){
            ...
            //CONDICION MENOR DE 12 AÑOS CON DISCAPACIDAD
            if(edad<12 and discapacidad == 'S'){
                 pF = precioBoleto - ((precioBoleto*0.10) + precioBoleto*0.15);
            }
                //CONDICION MAYORES A 60 AÑOS
                if (edad>=60){
                    pF = precioBoleto - (precioBoleto*0.30);
                }
                    //CONDICION MAYORES A 60 AÑOS CON DISCAPACIDAD
                        ...
                        if(embarazo == 'S'){
                            ...
                            if(embarazo == 'S' and discapacidad == 'S'){
                                ...
                                if(edad > 12 and edad < 60 and discapacidad == 'S'){
                                    ...
                                    //CONDICION PARA PERSONAS MAYORES DE 12 AÑOS Y MENORES DE 60, SIN DISCAPACIDAD Y SIN EMBARAZO
